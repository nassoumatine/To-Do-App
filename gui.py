...
window = sg.Window('My To-Do App',
                   ...
                   font=('Helvetica', 20))
while True:
    event, values = window.read(timeout=10)  # This s a tuple of the event(button pressed), and a dict with jet
    ...
    match event:
        ...
        case "Complete":
            try:
                ...
                sg.popup("Please select an item to complete first", font=("Helvetica", 20))
